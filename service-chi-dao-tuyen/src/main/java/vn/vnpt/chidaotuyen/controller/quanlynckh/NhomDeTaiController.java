...
import vn.vnpt.chidaotuyen.dao.quanlynckh.nhomdetai.NhomDeTaiDAO;
...
public class NhomDeTaiController {
    ...
    @ApiOperation("Lấy danh sách nhóm đề tài theo tên")
    @RequestMapping(value = "nhom-de-tai/lay-danh-sach-nhom-de-tai-theo-ten", produces = "application/json; charset=utf-8", method = RequestMethod.GET)
    public @ResponseBody
    List getDanhSachNhomDeTaiTheoTen(@RequestParam(value = "nhomDeTai", required = false) String nhomDeTai)
    {
        return nhomDeTaiDAO.getDanhSachNhomDeTaiTheoTen(nhomDeTai);
    }
