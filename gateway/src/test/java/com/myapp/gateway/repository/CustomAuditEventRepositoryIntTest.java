package com.myapp.gateway.repository;

import com.myapp.gateway.GatewayApp;
import com.myapp.gateway.config.Constants;
import com.myapp.gateway.config.audit.AuditEventConverter;
import com.myapp.gateway.domain.PersistentAuditEvent;
...
import static com.myapp.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
