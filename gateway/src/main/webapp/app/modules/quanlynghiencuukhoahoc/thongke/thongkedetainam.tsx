...
import { getDanhSachTinhThanh, getDanhSachDonVi, printDSDeTaiNam, reset } from './thongkenckh.reducer';
import { IRootState } from 'app/shared/reducers';

export interface IThongKeDeTaiNamProps extends StateProps, DispatchProps, RouteComponentProps<{}> {}
...
export class DanhSachThongKeDeTaiNam extends React.Component<IThongKeDeTaiNamProps, IDeTaiState, HTMLElement> {
    state: IDeTaiState = {
    ...
    printDanhSachDeTaiNam = () => {
        this.props.printDSDeTaiNam(this.state.ma_don_vi, this.state.nam_kh);
    }
    render() {
        ...
        return (
            <Modal isOpen toggle={this.dongHopThoai}>
                ...
                <ModalFooter>
                    ...
                    &nbsp;
                    <Button disabled={loading} color="primary" onClick={this.printDanhSachDeTaiNam}>
                        { !loading ? (<span>
...
const mapDispatchToProps = { getDanhSachTinhThanh, getDanhSachDonVi, printDSDeTaiNam, reset };
