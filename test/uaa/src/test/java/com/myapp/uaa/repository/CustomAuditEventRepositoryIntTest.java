package com.myapp.uaa.repository;

import com.myapp.uaa.UaaApp;
import com.myapp.uaa.config.Constants;
import com.myapp.uaa.config.audit.AuditEventConverter;
import com.myapp.uaa.domain.PersistentAuditEvent;
...
import static com.myapp.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
