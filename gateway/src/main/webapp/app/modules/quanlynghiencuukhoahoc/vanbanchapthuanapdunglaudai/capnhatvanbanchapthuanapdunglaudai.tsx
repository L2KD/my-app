...
import { getVanBanChapThuanApDungLauDai, updateVanBanChapThuanApDungLauDai, uploadTapTinVanBanChapThuanApDungLauDai } from './vanbanchapthuanapdunglaudai.reducer';
...
export class CapNhatVanBanApDungLauDaiDeTaiScript extends React.Component<ICapNhatVanBanApDungLauDaiProps> {
    ...
    componentDidMount(): void {
        this.props.getVanBanChapThuanApDungLauDai(this.props.match.params.detai);
    }
    componentWillReceiveProps(nextProps: Readonly<ICapNhatVanBanApDungLauDaiProps>, nextContext: any): void {
        this.setState({ tap_tin: nextProps.vanbanchapthuanapdunglaudai.tapTin });
    }
    ...
    uploadFileVanBanApDungLauDai = e => {
        ...
        this.props.uploadTapTinVanBanChapThuanApDungLauDai(data);
    }
    updateVanBanApDungLauDai = (event, values) => {
        ...
        this.props.updateVanBanChapThuanApDungLauDai(values, donvi, nam, trangthai);
...
const mapStateToProps = (storeState: IRootState) => ({
    vanbanchapthuanapdunglaudai: storeState.vanbanchapthuanapdunglaudai.van_ban_chap_thuan_ap_dung_lau_dai
});

const mapDispatchToProps = { getVanBanChapThuanApDungLauDai, updateVanBanChapThuanApDungLauDai, uploadTapTinVanBanChapThuanApDungLauDai };
