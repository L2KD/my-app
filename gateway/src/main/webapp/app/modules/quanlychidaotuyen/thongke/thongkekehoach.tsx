...
import { getDanhSachTinhThanh, getDanhSachCoQuanBanHanh, getDanhSachDonVi, printDSKH, reset } from './thongke.reducer';
import { IRootState } from 'app/shared/reducers';

export interface IThongKeKeHoachProps extends StateProps, DispatchProps, RouteComponentProps<{}> {}
...
export class DanhSachThongKeKeHoach extends React.Component<IThongKeKeHoachProps, IKeHoachState, HTMLElement> {
    state: IKeHoachState = {
    ...
    printDanhSachKeHoach = () => {
        this.props.printDSKH(this.state.ma_don_vi, this.state.nam_kh);
    }
    render() {
        ...
        return (
            <Modal isOpen toggle={this.dongHopThoai}>
                ...
                <ModalFooter>
                    ...
                    &nbsp;
                    <Button disabled={loading} color="primary" onClick={this.printDanhSachKeHoach}>
                        { !loading ? (<span>
...
const mapDispatchToProps = { getDanhSachTinhThanh, getDanhSachCoQuanBanHanh, getDanhSachDonVi, printDSKH, reset };
