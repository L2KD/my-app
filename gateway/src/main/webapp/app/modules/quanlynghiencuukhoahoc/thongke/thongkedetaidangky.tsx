...
import { getDanhSachTinhThanh, getDanhSachDonVi, printDSDeTaiDangKy, reset } from './thongkenckh.reducer';
...
export class DanhSachThongKeDeTaiDangKy extends React.Component<IThongKeDeTaiDangKyProps, IDeTaiState, HTMLElement> {
    state: IDeTaiState = {
    ...
    printDanhSachDeTaiDangKy = () => {
        this.props.printDSDeTaiDangKy(this.state.ma_don_vi, this.state.nam_kh);
    }
    render() {
        ...
        return (
            <Modal isOpen toggle={this.dongHopThoai}>
                ...
                <ModalFooter>
                    ...
                    &nbsp;
                    <Button disabled={loading} color="primary" onClick={this.printDanhSachDeTaiDangKy}>
                        { !loading ? (<span>
...
const mapDispatchToProps = { getDanhSachTinhThanh, getDanhSachDonVi, printDSDeTaiDangKy, reset };
