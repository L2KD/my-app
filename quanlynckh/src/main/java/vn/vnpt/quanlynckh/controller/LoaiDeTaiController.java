...
import vn.vnpt.quanlynckh.dao.LoaiDeTaiDAO;
...
public class LoaiDeTaiController {
    ...
    @RequestMapping(value = "loai-de-tai/lay-danh-sach-loai-de-tai", produces = "application/json; charset=utf-8", method = RequestMethod.GET)
    public @ResponseBody
