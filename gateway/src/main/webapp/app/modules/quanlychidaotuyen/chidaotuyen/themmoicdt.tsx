...
import { getDanhSachDonVi, getDanhSachKeHoach, getDanhSachNam, getDanhSachHinhThuc,
    ...
    uploadCDT, getMaxMaCDT, getCDT, addCDT_1, updateCDT, reset } from './cdt.reducer';
...
export interface IThemMoiCDTProps extends StateProps, DispatchProps, RouteComponentProps<{
    donvi: string, tinhthanh: string, nam: string, kehoach: string }> {}
...
export class ThemCDT extends React.Component<IThemMoiCDTProps, IThemMoiCDTState> {
    ...
    luuCDT = (event, values) => {
        if (values.donVi !== '-1' && values.keHoach !== '-1' && values.hinhThuc !== '-1' && values.loaiCDT !== '-1'
            && values.donViTiepNhan !== '-1' && values.khoaPhong !== '-1') {
        this.props.addCDT_1(values, this.props.maxma + 1, this.state.ds_noi_dung, this.state.ds_doi_tuong,
    ...
    render() {
        ...
        const { ds_don_vi, ds_hinh_thuc, ds_don_vi_tiep_nhan,
            ...
            ds_khoa_phong, ds_nhan_vien, ds_nhan_vien_tiep_nhan, updating } = this.props;
        return (
            <div>
                <Row className="justify-content-center">
                    <Col md="5">
                        <h1>Thêm mới chỉ đạo tuyến</h1>
                    </Col>
                </Row>
                <AvForm onValidSubmit={ this.luuCDT }>
                    <Row className="justify-content-center">
                        <Col md="5">
                            <Row md="5">
                                ...
                                <Col>
                                    <AvGroup>
                                        <label style={ { fontWeight: 900 } }>Ngày thực hiện <span style={{ color: 'red' }}>*</span></label>
                                        <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                                 type="date"
                                                 name="ngayThucHien"
                                                 required
                                    ...
                                    <AvGroup>
                                        <label style={ { fontWeight: 900 } }>Kế hoạch <span style={{ color: 'red' }}>*</span></label>
                                        <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                                 type="select"
                                                 name="keHoach"
                                                 required
                                                 validate={{
                                                     required: {
                                                         value: true,
                                                         errorMessage: 'Chưa chọn kế hoạch chỉ đạo tuyến'
                                                     }
                                                 }}
                                        >
                                    ...
                                    <AvGroup>
                                        <label style={ { fontWeight: 900 } }>Hình thức chỉ đạo tuyến <span style={{ color: 'red' }}>*</span></label>
                                        <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                                 type="select"
                                                 name="hinhThuc"
                                                 required
                                                 validate={{
                                                     required: {
                                                         value: true,
                                                         errorMessage: 'Chưa chọn hình thức chỉ đạo tuyến'
                                                     }
                                                 }}
                                        >
                                            <option value="">--Chọn hình thức chỉ đạo tuyến</option>
                                            {
                                                ds_hinh_thuc.filter(o => o.trang_thai === 1).map((ele, i) => (
                                    ...
                                    <AvGroup>
                                        <label style={ { fontWeight: 900 } }>Loại chỉ đạo tuyến <span style={{ color: 'red' }}>*</span></label>
                                        <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                                 type="select"
                                                 name="loaiCDT"
                                                 required
                                                 validate={{
                                                     required: {
                                                         value: true,
                                                         errorMessage: 'Chưa chọn loại chỉ đạo tuyến'
                                                     }
                                                 }}
                                        >
                                            <option value="">--Chọn loại chỉ đạo tuyến</option>
                                            {
                            ...
                            <AvGroup>
                                <Label style={ { fontWeight: 900 } }>Nội dung chỉ đạo tuyến <span style={{ color: 'red' }}>*</span></Label>
                                <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                         readOnly name="noi_dung" value={ this.state.ds_noi_dung.map((ele, i) => (ele.noiDung))} required/>
                                <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                         type="select" name="noiDung" multiple onChange={this.handleMultiSelectNoiDung}>
                                    {
                                        ds_noi_dung.filter(o => o.trangThai === 1).map((ele, i) => (
                                    ...
                                    <AvGroup>
                                        <label style={ { fontWeight: 900 } }>Đơn vị tiếp nhận <span style={{ color: 'red' }}>*</span></label>
                                        <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                                 type="select"
                                                 name="donViTiepNhan"
                                                 onChange={this.handleSelectDonViTiepNhan}
                                                 required
                                                 validate={{
                                                     required: {
                                                         value: true,
                                                         errorMessage: 'Chưa chọn đơn vị tiếp nhận'
                                                     }
                                                 }}
                                        >
                            ...
                            <AvGroup>
                                <Label style={ { fontWeight: 900 } }>Đối tượng tiếp nhận <span style={{ color: 'red' }}>*</span></Label>
                                <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                         readOnly name="doi_tuong" value={ this.state.ds_doi_tuong.map((ele, i) => (ele.tenDoiTuong))} required/>
                                <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                         type="select" name="doiTuong" multiple onChange={this.handleMultiSelectDoiTuong} required>
                                    {
                                        ds_doi_tuong.filter(o => o.trangThai === 1).map((ele, i) => (
                    ...
                    <Col md="6">
                            <AvGroup>
                                <Label style={ { fontWeight: 900 } }>Khoa phòng <span style={{ color: 'red' }}>*</span></Label>
                                <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                         type="select"
                                         name="khoaPhong"
                                         onChange={this.handleSelectKhoaPhong}
                                         validate={{
                                             required: {
                                                 value: true,
                                                 errorMessage: 'Chưa chọn khoa phòng'
                                             }
                                         }}
                                >
                            ...
                            <AvGroup>
                                <Label style={ { fontWeight: 900 } }>Cá nhân phụ trách <span style={{ color: 'red' }}>*</span></Label>
                                <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                         readOnly name="noi_dung" value={ this.state.ds_ca_nhan.map((ele, i) => (ele.tenNhanVien))} required/>
                                <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                         type="select" name="nhanVien" multiple onChange={this.handleMultiSelectCaNhanPhuTrach} required>
                                    {
                                    ...
                                    <AvGroup>
                                        <label style={ { fontWeight: 900 } }>Trưởng đoàn <span style={{ color: 'red' }}>*</span></label>
                                        <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                                 type="select"
                                                 name="truongDoan"
                                                 required
                                                 validate={{
                                                     required: {
                                                         value: true,
                                                         errorMessage: 'Chưa chọn trưởng đoàn'
                                                     }
                                                 }}
                                        >
                                    ...
                                    <AvGroup>
                                        <label style={ { fontWeight: 900 } }>Thư ký <span style={{ color: 'red' }}>*</span></label>
                                        <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                                 type="select"
                                                 name="thuKi"
                                                 required
                            ...
                            <AvGroup>
                                <label style={ { fontWeight: 900 } }>Số người tiếp nhận <span style={{ color: 'red' }}>*</span></label>
                                <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                         type="number"
                                         name="soNguoiTiepNhan"
                                         min="1"
                                         required
                                         validate={{
                                             required: {
                                                 value: true,
                                                 errorMessage: 'Chưa chọn số người tiếp nhận'
                                             }
                                         }}
                                />
                            </AvGroup>
                            <AvGroup>
                                <Label style={ { fontWeight: 900 } }>Người tiếp nhận <span style={{ color: 'red' }}>*</span></Label>
                                ...
                                <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                         type="select" name="nguoiTiepNhan" multiple onChange={this.handleMultiSelectCaNhanTiepNhan} required>
                                    {
                                    ...
                                    <AvGroup>
                                        <label style={ { fontWeight: 900 } }>Người đại diện <span style={{ color: 'red' }}>*</span></label>
                                        <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                                 type="select"
                                                 name="nguoiDaiDien"
                                                 required
                                                 validate={{
                                                     required: {
                                                         value: true,
                                                         errorMessage: 'Chưa chọn người đại diện'
                                                     }
                                                 }}
                                        >
                        ...
                        <AvGroup>
                            ...
                            <AvField style={ { fontWeight: 'bold', borderColor: '#0066ff', borderRadius: '5px', backgroundColor: 'white' } }
                                     hidden name="filecdt" id="filecdt" type="file" onChange={this.uploadTapTinCDT}/>
                            <Row>
                                <Col>
...
const mapDispatchToProps = { getDanhSachDonVi, getDanhSachKeHoach, getDanhSachNam,
    ...
    getCDT, addCDT_1, updateCDT, reset, getDanhSachDonViTiepNhan, getDanhSachDoiTuong,
    getDanhSachKhoaPhong, getDanhSachNhanVien, getDanhSachNhanVienTiepNhan };
